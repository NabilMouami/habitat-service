    ...
    <div>
      <section className="footer">
        <div className="box-container">
          ...
          <div className="box">
            <h3>Nos agences</h3>
            <h5 style={{ color: "#222", textDecoration: "underline" }}>
              Oujda
            </h5>
            <p>
              <PlaceIcon style={{ color: "#161616" }} />N 17 Bis Rue B 60 Hay si
              Lakhdar - Oujda
            </p>
            <p>
              <FaxIcon />
              Fax:0536687712/0536358535
            </p>
            <h5 style={{ color: "#222", textDecoration: "underline" }}>
              Nador
            </h5>
            <p>
              <PlaceIcon style={{ color: "#161616" }} />
              Propriété El Mostaqbal Zone Industrielle Selouane-Nador
            </p>
            <p>
              <FaPhoneAlt style={{ color: "#161616" }} />
              Tel:0661440013/0666200104
            </p>
          </div>
        </div>

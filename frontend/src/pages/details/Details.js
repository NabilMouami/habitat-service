        ...
        <div classNmae="detail-flex">
          ...
          <div className="flex-desc">
            <div>
              ...
              <p className="flex-desc-p">{Bois.data.essences}</p>
            </div>
            <div>
              <span className="span-descr">utilisations:</span>
              <p className="flex-desc-p">{Bois.data.utilisations}</p>
            </div>
            <div>
              <span className="span-descr">DENSITÉ:</span>
              <p className="flex-desc-p">{Bois.data.DENSITÉ}</p>
            </div>
            <div>
              <span className="span-descr">Livraison:</span>
              <p className="flex-desc-p">{Bois.data.livraison}</p>
            </div>
            <div>
              <span className="span-descr">PROVENANCES:</span>
              <p className="flex-desc-p">{Bois.data.PROVENANCES}</p>
            </div>
            <div>
              <span className="span-descr">RÉSISTANCE:</span>
              <p className="flex-desc-p">{Bois.data.RÉSISTANCE}</p>
            </div>
            <div>
              <span className="span-descr">Classifications:</span>
              <p className="flex-desc-p">{Bois.data.classes}</p>
            </div>
            <div>
              <span className="span-descr">longueurs(m):</span>
              <p className="flex-desc-p">{Bois.data.long}</p>
            </div>
            <div>
              <span className="span-descr">epaisseur(mm):</span>
              <p className="flex-desc-p">{Bois.data.epaisseur}</p>
            </div>
            <div>
              <span className="span-descr">largeurs(mm):</span>
              <p className="flex-desc-p">{Bois.data.larg}</p>
            </div>
          </div>

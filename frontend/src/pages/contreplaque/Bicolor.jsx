...
const Bicolor = () => {
  ...
  <>
    <div className="bande-ch">
      <img src="/assets/BandeCh/BchBicolori.jpg" alt="" style={{ width: "100%" }} className="bande-img"/>
      <h3 className='t-bande'>Bande De Chand Bicolor 3D</h3>
      <section class="portfolio-ex top-ex">
        <div class="container-ex flex-ex">
          ...
          <div class="right-ex grid-ex">
            <div class="box-ex">
              <div class="img-ex">
                <img src="/assets/BandeCh/bicoloruse1.jpg" class="image-ex" style={{width: "100%",height: "340px"}} />
              </div>
       
            </div>
            <div class="box-ex">
              <div class="img-ex">
                <img src="/assets/BandeCh/bicoloruse2.jpg" class="image-ex" style={{width: "100%",height: "340px"}} />
              </div>
            </div>
            <div class="box-ex">
              <div class="img-ex">
                <img src="/assets/BandeCh/bicoloruse3.png" class="image-ex" style={{width: "100%",height: "340px"}} />
              </div>
             
            </div>
            <div class="box-ex">
              <div class="img-ex">
                <img src="/assets/BandeCh/bicoloruse4.jpg" class="image-ex" style={{width: "100%",height: "340px"}} />
              </div>
